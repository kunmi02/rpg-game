...
//       } else {
//         const coin = this.physics.add.sprite(posX, posY - 90, 'star').setScale(1);
...
//   this.player = this.physics.add.sprite(gameOptions.playerStartPosition, this.sys.scale.height * 0.7, 'dude');
